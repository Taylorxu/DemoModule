    ...
    companion object {
        ...
        fun openWirelessSettings() {
            if (android.os.Build.VERSION.SDK_INT > 10) {
                ...
                Utils.getContext()
                    .startActivity(Intent(android.provider.Settings.ACTION_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK))
            }
        }
        ...
        var dataEnabled: Boolean
            ...
            set(enabled) = try {
                ...
                val setMobileDataEnabledMethod =
                    tm.javaClass.getDeclaredMethod("setDataEnabled", Boolean::class.javaPrimitiveType!!).apply {
                        invoke(tm, enabled)
                    }
            } catch (e: Exception) {
                e.printStackTrace()
